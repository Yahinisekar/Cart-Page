...
const Cart = () => {
    ...
    const totalPrice=productList.reduce((total,productList)=>total+ productList.price*(productList.quantity ||1),0)
    const totalQty = productList.reduce((total, productList) => total + (productList.quantity || 1), 0)
                      ...
                      <div className='row' >
                          ...
                          <div className="card-body col-md-8 col-sm-12">
                              ...
                              <div className="stars" id="stars">
                                  <span className="star1" data-value="1">&#9733;</span>
                                  <span className="star2" data-value="2">&#9733;</span>
                                  <span className="star3" data-value="3">&#9733;</span>
                                  <span className="star4" data-value="4">&#9733;</span>
                                  <span className="star5" data-value="5">&#9733;</span>
                                      </div> 
